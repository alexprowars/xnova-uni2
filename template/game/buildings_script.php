...
<table width="700">
<tr>
	<td class="c" >Текущее производство</td>
</tr>
<tr>
	<th><div id=bx class=z></div></th>
</tr>
<tr>
	<td class="c" >Очередь производства</td>
</tr>
<tr>
	<th ><select name="auftr" disabled size="5" style="width:400px;text-align:center;"></select></th>
</tr>
<tr>
	<td class="c" >Оставшееся время <?=$parse['pretty_time_b_hangar'] ?></td>
</tr>
</table>
</form>
