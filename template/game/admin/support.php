<br><table width="700px">
	...
	<tr>
		<td class="c" width="10%"><center>ID</center></td>
		<td class="c" width="10%"><center>Игрок</center></td>
		<td class="c" width="40%"><center>Тема</center></td>
		<td class="c" width="15%"><center>Статус</center></td>
		<td class="c" width="25%"><center>Дата</center></td>
	</tr>
    <? foreach($tickets['open'] AS $list): ?>
	<tr><th><?=$list['id'] ?></th><th><?=$list['username'] ?></th><th><a href="?set=admin&amp;mode=support&amp;action=detail&amp;id=<?=$list['id'] ?>"><?=$list['subject'] ?></a></th><th><?=$list['status'] ?></th><th><?=$list['date'] ?></th></tr>
	<? endforeach; ?>
...
<table width="700px">
	<tr>
		<td colspan="5" class="c" width="500"><center>Служба техподдержки</center></td>
	</tr>
	<tr>
		<td class="c" width="10%"><center>ID</center></td>
		<td class="c" width="10%"><center>Игрок</center></td>
