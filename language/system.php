...
$lang['sys_expe_found_dm_1_1']         = 'Экспедиции удалось поймать и законсервировать немного Тёмной материи.';
$lang['sys_expe_found_dm_1_2']         = 'Ваша экспедиция обнаружила корабль-призрак, который перевозил небольшое количество Тёмной материи. Мы не смогли найти доказательство того, что произошло с его экипажем, однако, наши специалисты смогли переправить Тёмная материя с корабля-призрака на борт экспедиции.';
$lang['sys_expe_found_dm_1_3']         = 'Мы наталкнулись на маленький корабль передставителя инопланетной расы, который в обмен на несколько простых математических расчётов предоставил нам небольшой контейнер с Тёмной материей.';
$lang['sys_expe_found_dm_1_4']         = 'Мы нашли остатки корабля чужих. На борту был небольшой контейнер с Тёмной материей!';
$lang['sys_expe_found_dm_1_5']         = 'Экспедиция следовала за какими-то странными сигналами и обнаружила маленьких размеров астероид, в ядре которого находились Тёмная материя. Астероид был доставлен на борт и учёные извлекли из него Тёмная материя.';
$lang['sys_expe_found_dm_2_1']         = 'Нашей экспедиции удался уникальный эксперимент. Из затухающей звезды им удалось добыть Тёмную материю!';
$lang['sys_expe_found_dm_2_2']         = 'Ваша экспедиция сообщает о странном спектральном явлении. Это привело к образованию Тёмной материи на энергетических щитах кораблей. Наши специалисты пытаются законсервировать как можно больше Тёмной материи, пока это явление не исчезло.';
...
$lang['sys_expe_back_home']            = 'Ваш флот вернулся из экспедиции.<br>Флот доставил груз: %s %s, %s %s, %s %s и %s %s.';
